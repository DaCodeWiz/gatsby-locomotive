...
// EXTERNAL MODULE: external "/Users/jakepearson/Desktop/hopefully this works/app/node_modules/react/index.js"
var index_js_ = __webpack_require__(4659);
var index_js_default = /*#__PURE__*/__webpack_require__.n(index_js_);
// EXTERNAL MODULE: ./node_modules/tiny-emitter/index.js
var tiny_emitter = __webpack_require__(4279);
...
;// CONCATENATED MODULE: ./src/Components/Home/ScrollCTA/ScrollCTA.js
const ScrollCTA=()=>{const{0:opacity,1:setOpacity}=(0,index_js_.useState)(.5);const handleScroll=()=>{const opacity=window.scrollY>100?0:.5;setOpacity(opacity);};(0,index_js_.useEffect)(()=>{window.addEventListener('scroll',handleScroll);return()=>window.removeEventListener('scroll',handleScroll);},[]);//opening fade in
const scrollCTA=(0,index_js_.useRef)(null);(0,index_js_.useEffect)(()=>{gsapWithCSS.fromTo(scrollCTA.current,{opacity:0},{opacity:.5,duration:1,delay:2.6});},[]);return/*#__PURE__*/index_js_default().createElement("p",{id:"scroll-cta",style:{'opacity':opacity},ref:scrollCTA},"Scroll to explore");};/* harmony default export */ const ScrollCTA_ScrollCTA = (ScrollCTA);
;// CONCATENATED MODULE: ./src/images/laanding-2.jpeg
/* harmony default export */ const laanding_2 = ("/static/laanding-2-b1667c478c14515744fa2e6940561dd0.jpeg");
;// CONCATENATED MODULE: ./src/Components/Home/Hero/Hero.js
// import Navbar from "../Navbar";
gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);function Hero(){//Opening animation
const backgroundWrapper=(0,index_js_.useRef)(null);const topSpans=[(0,index_js_.useRef)(null),(0,index_js_.useRef)(null),(0,index_js_.useRef)(null)];const headings=[(0,index_js_.useRef)(null),(0,index_js_.useRef)(null),(0,index_js_.useRef)(null)];(0,index_js_.useEffect)(()=>{const animate=()=>{//background
backgroundWrapper.current.style.transform='translateY(0)';//top spans
topSpans.forEach((span,i)=>{gsapWithCSS.fromTo(span.current,{rotation:10,opacity:0,y:()=>window.innerHeight*.5},{rotation:0,y:0,opacity:1,duration:1,ease:'power4.easeOut',delay:.6+i/20});});//headings
headings.forEach((heading,i)=>{gsapWithCSS.fromTo(heading.current,{rotation:10,opacity:0,y:()=>window.innerHeight*.5},{rotation:0,y:0,opacity:1,duration:1,ease:'power4.easeOut',delay:.8+i/10});});};setTimeout(()=>requestAnimationFrame(animate),2300);},[]);//Scroll Parallax
const backgroundImage=(0,index_js_.useRef)(null);(0,index_js_.useEffect)(()=>{gsapWithCSS.to(backgroundImage.current,{y:()=>window.innerHeight*2,opacity:.3,scale:1.4,scrollTrigger:{start:'top',end:'bottom',scrub:true}});},[]);return/*#__PURE__*/index_js_default().createElement("div",{id:"hero-container",onMouseMove:()=>window.cursorIcon?window.cursorIcon.show('Scroll'):null,onMouseLeave:()=>window.cursorIcon?window.cursorIcon.hide():null},/*#__PURE__*/index_js_default().createElement(ScrollCTA_ScrollCTA,null),/*#__PURE__*/index_js_default().createElement("div",{className:"content-width column"},/*#__PURE__*/index_js_default().createElement("div",{className:"hero-background loading-transition",ref:backgroundWrapper},/*#__PURE__*/index_js_default().createElement("img",{src:laanding_2,alt:"Background hero",ref:backgroundImage})),/*#__PURE__*/index_js_default().createElement("div",{className:"top-span-container"},/*#__PURE__*/index_js_default().createElement("div",{className:"anim"},/*#__PURE__*/index_js_default().createElement("span",{ref:topSpans[0]},"charmed by tech")),/*#__PURE__*/index_js_default().createElement("div",{className:"anim"},/*#__PURE__*/index_js_default().createElement("span",{ref:topSpans[1]},"and entertained by creativity.")),/*#__PURE__*/index_js_default().createElement("div",{className:"anim"},/*#__PURE__*/index_js_default().createElement("span",{ref:topSpans[2]},"\u201CMan is still the most extraordinary computer of all.\u201D"))),/*#__PURE__*/index_js_default().createElement("h1",null,/*#__PURE__*/index_js_default().createElement("div",{className:"hero-title-anim"},/*#__PURE__*/index_js_default().createElement("p",{ref:headings[0]},"Art")),/*#__PURE__*/index_js_default().createElement("div",{className:"hero-title-anim"},/*#__PURE__*/index_js_default().createElement("p",{ref:headings[1]},"In")),/*#__PURE__*/index_js_default().createElement("div",{className:"hero-title-anim"},/*#__PURE__*/index_js_default().createElement("p",{ref:headings[2]},"Motion"))),/*#__PURE__*/index_js_default().createElement("span",{className:"bottom-span"},"engineer / motion designer")));}
;// CONCATENATED MODULE: ./src/images/caspian.mp4
/* harmony default export */ const caspian = ("/static/caspian-bdaa839bf0551c1dc7de669a855faa84.mp4");
;// CONCATENATED MODULE: ./src/images/sebastien-bourguet-ZI1FT0B68K8-unsplash.jpg
/* harmony default export */ const sebastien_bourguet_ZI1FT0B68K8_unsplash = ("/static/sebastien-bourguet-ZI1FT0B68K8-unsplash-0a16cf0210aeb16f414a972938881a8e.jpg");
;// CONCATENATED MODULE: ./src/images/casey-olsen-2s11AHnb_SU-unsplash.jpg
/* harmony default export */ const casey_olsen_2s11AHnb_SU_unsplash = ("/static/casey-olsen-2s11AHnb_SU-unsplash-97510cb76adeac78e5e00ab299004980.jpg");
;// CONCATENATED MODULE: ./src/images/video1.mp4
/* harmony default export */ const video1 = ("/static/video1-105cf050f0ee98d766789a48abfdcb04.mp4");
;// CONCATENATED MODULE: ./src/Components/Home/News/News.js
gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);function News(){const wrapper=(0,index_js_.useRef)(null);const image1=(0,index_js_.useRef)(null);const image2=(0,index_js_.useRef)(null);const image3=(0,index_js_.useRef)(null);const image4=(0,index_js_.useRef)(null);const heading0=(0,index_js_.useRef)(null);const heading1=(0,index_js_.useRef)(null);(0,index_js_.useEffect)(()=>{//Image 0
gsapWithCSS.to(wrapper.current,{y:()=>window.innerHeight*.15,scrollTrigger:{trigger:wrapper.current,scrub:true,end:'bottom'}});//Image 1
gsapWithCSS.to(image1.current,{x:()=>-window.innerWidth*.12,y:()=>-window.innerHeight*.1,scrollTrigger:{trigger:image1.current,scrub:.98,start:'top bottom',end:'bottom top',endTrigger:wrapper.current}});//Image 2
gsapWithCSS.to(image2.current,{x:()=>window.innerWidth*.16,y:()=>-window.innerHeight*.03,scrollTrigger:{trigger:image2.current,scrub:.98,start:'top bottom',end:'bottom top',endTrigger:wrapper.current}});//Image 3
gsapWithCSS.to(image3.current,{x:()=>-window.innerWidth*.14,scrollTrigger:{trigger:image3.current,scrub:.98,start:'top bottom',end:'bottom top'}});//Image 4
gsapWithCSS.to(image4.current,{x:()=>window.innerWidth*.15,scrollTrigger:{trigger:image4.current,scrub:.98,start:'top bottom',end:'bottom top'}});//heading scroll trigger opening
gsapWithCSS.fromTo(heading0.current,{rotation:6,opacity:0,y:()=>heading0.current.clientHeight*.5},{rotation:0,y:0,opacity:1,duration:.7,ease:'power4.easeOut',scrollTrigger:{trigger:heading1.current,start:'center bottom'}});gsapWithCSS.fromTo(heading1.current,{rotation:6,opacity:0,y:()=>heading1.current.clientHeight*.5},{rotation:0,y:0,opacity:1,duration:.7,ease:'power4.easeOut',scrollTrigger:{trigger:heading1.current,start:'center bottom'}});},[]);return/*#__PURE__*/index_js_default().createElement("div",{id:"news-container",className:"center column"},/*#__PURE__*/index_js_default().createElement("div",{id:"news-media-container",ref:wrapper},/*#__PURE__*/index_js_default().createElement("div",{className:"news-media"},/*#__PURE__*/index_js_default().createElement("video",{playsInline:"",loop:"loop",muted:"muted",autoPlay:"autoPlay",disablePictureInPicture:""},/*#__PURE__*/index_js_default().createElement("source",{src:caspian,type:"video/mp4"}))),/*#__PURE__*/index_js_default().createElement("div",{className:"news-media",ref:image1},/*#__PURE__*/index_js_default().createElement("picture",null,/*#__PURE__*/index_js_default().createElement("source",{src:"https://images.pexels.com/photos/2121665/pexels-photo-2121665.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",type:"image/webp"}),/*#__PURE__*/index_js_default().createElement("img",{src:"https://images.pexels.com/photos/2121665/pexels-photo-2121665.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",loading:"lazy",alt:"luh shawty sign"}))),/*#__PURE__*/index_js_default().createElement("div",{className:"news-media",ref:image2},/*#__PURE__*/index_js_default().createElement("picture",{id:"3643671","data-v-4a179df6":""},/*#__PURE__*/index_js_default().createElement("source",{type:"image/webp",srcSet:sebastien_bourguet_ZI1FT0B68K8_unsplash}),/*#__PURE__*/index_js_default().createElement("img",{src:casey_olsen_2s11AHnb_SU_unsplash,alt:"a guy holding a camera",loading:"lazy"}))),/*#__PURE__*/index_js_default().createElement("div",{className:"news-media",ref:image3},/*#__PURE__*/index_js_default().createElement("picture",null,/*#__PURE__*/index_js_default().createElement("source",{type:"image/webp",srcSet:casey_olsen_2s11AHnb_SU_unsplash}),/*#__PURE__*/index_js_default().createElement("img",{alt:"welcome sign",loading:"lazy"}))),/*#__PURE__*/index_js_default().createElement("div",{className:"news-media",ref:image4},/*#__PURE__*/index_js_default().createElement("video",{playsInline:"",loop:"loop",muted:"muted",autoPlay:"autoPlay",disablePictureInPicture:""},/*#__PURE__*/index_js_default().createElement("source",{src:video1,type:"video/mp4"})))),/*#__PURE__*/index_js_default().createElement("div",{className:"row"},/*#__PURE__*/index_js_default().createElement("svg",{viewBox:"0 0 12 12",fill:"#fff",xmlns:"http://www.w3.org/2000/svg",className:"icon","data-v-669b4a84":""},/*#__PURE__*/index_js_default().createElement("path",{d:"M7.41908 4.56679L6.13722 0L4.85418 4.92566L0 6L4.85418 7.25435L6.13722 12L7.3276 7.25435L12 6L7.41908 4.56679Z"})),/*#__PURE__*/index_js_default().createElement("p",{className:"news-small-heading"},"popularity")),/*#__PURE__*/index_js_default().createElement("h2",null,/*#__PURE__*/index_js_default().createElement("div",{className:"anim"},/*#__PURE__*/index_js_default().createElement("div",{ref:heading0},"let's")),/*#__PURE__*/index_js_default().createElement("div",{className:"anim"},/*#__PURE__*/index_js_default().createElement("div",{ref:heading1},"talk"))),/*#__PURE__*/index_js_default().createElement("p",{className:"news-text"},"i am interested in working with you,",/*#__PURE__*/index_js_default().createElement("br",null),"any inquiries or requests are welcome to contact me."));}
;// CONCATENATED MODULE: ./src/vids/payhipUwU.mp4
/* harmony default export */ const payhipUwU = ("/static/payhipUwU-9a46ec7d4ee8629115510635ab2ff2a9.mp4");
;// CONCATENATED MODULE: ./src/Components/Home/Reel/VideoPlayer.js
const VideoPlayer=({handleClick,handleScroll})=>{const container=(0,index_js_.useRef)(null);(0,index_js_.useEffect)(()=>{gsapWithCSS.fromTo(container.current,{opacity:0},{opacity:1});},[]);const onClick=()=>{handleClick();};const onWheel=()=>{handleScroll();};return/*#__PURE__*/index_js_default().createElement("div",{ref:container,onClick:onClick,onWheel:onWheel,className:"video-player"},/*#__PURE__*/index_js_default().createElement("video",{autoPlay:"autoplay"},/*#__PURE__*/index_js_default().createElement("source",{src:payhipUwU,type:"video/mp4"})));};/* harmony default export */ const Reel_VideoPlayer = (VideoPlayer);
;// CONCATENATED MODULE: ./src/Components/Home/Reel/Reel.js
gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);function HomeReel(){const{0:isPlaying,1:setIsPlaying}=(0,index_js_.useState)(false);const video=(0,index_js_.useRef)(null);const container=(0,index_js_.useRef)(null);const heading0=(0,index_js_.useRef)(null);const heading1=(0,index_js_.useRef)(null);(0,index_js_.useEffect)(()=>{const timeline=gsapWithCSS.timeline({scrollTrigger:{trigger:container.current,scrub:.99,onEnter:()=>video.current.play(),pinSpacing:true,pin:true}});// Scale Video to fill container
timeline.to(video.current,{scale:1},0);// Headings
timeline.to(heading0.current,{x:0},0);timeline.to(heading1.current,{x:0},0);},[]);const handleClick=()=>{setIsPlaying(!isPlaying);};const handleScroll=()=>{if(isPlaying)setIsPlaying(false);};return/*#__PURE__*/index_js_default().createElement("div",{id:"reel-wrapper"},/*#__PURE__*/index_js_default().createElement("div",{id:"reel-container",className:"center column",ref:container,onClick:handleClick,onWheel:handleScroll},/*#__PURE__*/index_js_default().createElement("div",{className:"row center",id:"reel-top-p"},/*#__PURE__*/index_js_default().createElement("svg",{viewBox:"0 0 12 12",xmlns:"http://www.w3.org/2000/svg",className:"icon","data-v-669b4a84":""},/*#__PURE__*/index_js_default().createElement("path",{d:"M7.41908 4.56679L6.13722 0L4.85418 4.92566L0 6L4.85418 7.25435L6.13722 12L7.3276 7.25435L12 6L7.41908 4.56679Z",fill:"currentColor","data-v-669b4a84":""})),/*#__PURE__*/index_js_default().createElement("p",null,"who is Jake?")),/*#__PURE__*/index_js_default().createElement("div",{className:"row center"},/*#__PURE__*/index_js_default().createElement("h2",{ref:heading0},"Support"),/*#__PURE__*/index_js_default().createElement("video",{playsInline:"",loop:"loop",muted:"muted",disablePictureInPicture:"",ref:video,className:"video"},/*#__PURE__*/index_js_default().createElement("source",{src:payhipUwU,type:"video/mp4"})),/*#__PURE__*/index_js_default().createElement("h2",{ref:heading1},"My Work")),/*#__PURE__*/index_js_default().createElement("p",{id:"reel-bottom-p"},"Payhip is where I keep source code",/*#__PURE__*/index_js_default().createElement("br",null),"along with other digital assets :P")),isPlaying?/*#__PURE__*/index_js_default().createElement(Reel_VideoPlayer,{handleClick:handleClick,handleScroll:handleScroll}):null);}/* harmony default export */ const Reel = (HomeReel);
;// CONCATENATED MODULE: ./src/images/primera.mp4
/* harmony default export */ const primera = ("/static/primera-8e8232c051967c45cb4974425142d427.mp4");
;// CONCATENATED MODULE: ./src/images/work-2.mp4
/* harmony default export */ const work_2 = ("/static/work-2-de974a8975a448abce3c2a7ba7231a83.mp4");
;// CONCATENATED MODULE: ./src/images/beats-ad.mp4
/* harmony default export */ const beats_ad = ("/static/beats-ad-fe516df074f508d5c20950138441bb1e.mp4");
;// CONCATENATED MODULE: ./src/images/primera-sc.png
/* harmony default export */ const primera_sc = ("/static/primera-sc-500d52f0f0e6eba86ff4c5955b9e2efa.png");
;// CONCATENATED MODULE: ./src/Components/Home/Work/Work.js
gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);function Work(){const image1=(0,index_js_.useRef)(null);const image3=(0,index_js_.useRef)(null);const heading=(0,index_js_.useRef)(null);(0,index_js_.useEffect)(()=>{//image 1
gsapWithCSS.fromTo(image1.current,{y:100},{y:-130,scrollTrigger:{trigger:image1.current,scrub:true}});//image 3
gsapWithCSS.fromTo(image3.current,{y:-50},{y:100,scrollTrigger:{trigger:image3.current,scrub:true}});//heading scroll trigger opening
gsapWithCSS.fromTo(heading.current,{rotation:6,opacity:0,y:()=>heading.current.clientHeight*.5},{rotation:0,y:0,opacity:1,duration:.7,ease:'power4.easeOut',scrollTrigger:{trigger:heading.current,start:'center bottom'}});},[]);const handleMouseEnter=event=>{//play video
const video=event.target.children[1];if(video?video.classList.contains('video'):false)video.play();//animation
const text=event.target.children[2].children[0];if(text){gsapWithCSS.killTweensOf(text);gsapWithCSS.fromTo(text,{rotation:10,opacity:0,y:()=>text.clientHeight*.5},{rotation:0,y:0,opacity:1,duration:.7,ease:'power4.easeOut'});}};const handleMouseLeave=event=>{//pause video
const video=event.target.children[1];if(video?video.classList.contains('video'):false)video.pause();//animation
const text=event.target.children[2].children[0];if(text){gsapWithCSS.killTweensOf(text);gsapWithCSS.fromTo(text,{rotation:0,opacity:1,y:0},{rotation:-10,y:-text.clientHeight,opacity:0,duration:.5,ease:'power4.easeOut'});}};return/*#__PURE__*/index_js_default().createElement("section",{className:"column content-width",id:"work-section"},/*#__PURE__*/index_js_default().createElement("div",{className:"anim"},/*#__PURE__*/index_js_default().createElement("h1",{ref:heading},"creations")),/*#__PURE__*/index_js_default().createElement("div",{className:"row"},/*#__PURE__*/index_js_default().createElement("div",{id:"block-0",className:"block",onMouseEnter:handleMouseEnter,onMouseLeave:handleMouseLeave},/*#__PURE__*/index_js_default().createElement("img",{src:primera_sc,height:"3113",alt:"Project 1",loading:"lazy"}),/*#__PURE__*/index_js_default().createElement("video",{playsInline:"",loop:"loop",muted:"muted",disablePictureInPicture:"",className:"video"},/*#__PURE__*/index_js_default().createElement("source",{src:primera,type:"video/mp4"})),/*#__PURE__*/index_js_default().createElement("div",{className:"text-wrapper"},/*#__PURE__*/index_js_default().createElement("p",null,/*#__PURE__*/index_js_default().createElement("span",null,/*#__PURE__*/index_js_default().createElement("strong",null,"Under Development")),/*#__PURE__*/index_js_default().createElement("span",null," Currently Unavailable")))),/*#__PURE__*/index_js_default().createElement("div",{className:"column",id:"work-right-section"},/*#__PURE__*/index_js_default().createElement("div",{className:"row"},/*#__PURE__*/index_js_default().createElement("svg",{viewBox:"0 0 12 12",fill:"#1D2C27",xmlns:"http://www.w3.org/2000/svg",className:"icon","data-v-669b4a84":""},/*#__PURE__*/index_js_default().createElement("path",{d:"M7.41908 4.56679L6.13722 0L4.85418 4.92566L0 6L4.85418 7.25435L6.13722 12L7.3276 7.25435L12 6L7.41908 4.56679Z"})),/*#__PURE__*/index_js_default().createElement("span",null,"Featured Projects")),/*#__PURE__*/index_js_default().createElement("p",{className:"quote"},/*#__PURE__*/index_js_default().createElement("br",null),"my works (currently ongoing...)"),/*#__PURE__*/index_js_default().createElement("div",{id:"block-1",className:"block",ref:image1,onMouseEnter:handleMouseEnter,onMouseLeave:handleMouseLeave},/*#__PURE__*/index_js_default().createElement("img",{src:"https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1055&q=80",alt:'picture of dude being cash money'}),/*#__PURE__*/index_js_default().createElement("video",{playsInline:"",loop:"loop",muted:"muted",disablePictureInPicture:"",className:"video"},/*#__PURE__*/index_js_default().createElement("source",{src:work_2,type:"video/mp4"})),/*#__PURE__*/index_js_default().createElement("div",{className:"text-wrapper"},/*#__PURE__*/index_js_default().createElement("p",null,/*#__PURE__*/index_js_default().createElement("span",null,/*#__PURE__*/index_js_default().createElement("strong",null,"Under Development ")),/*#__PURE__*/index_js_default().createElement("span",null,"photography portfolio")))))),/*#__PURE__*/index_js_default().createElement("div",{className:"row"},/*#__PURE__*/index_js_default().createElement("div",{id:"block-2",className:"block",onMouseEnter:handleMouseEnter,onMouseLeave:handleMouseLeave},/*#__PURE__*/index_js_default().createElement("img",{src:"https://images.unsplash.com/photo-1627697823116-42877786ac26?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80",alt:'dude is being extremely cash money'}),/*#__PURE__*/index_js_default().createElement("video",{playsInline:"",loop:"loop",muted:"muted",disablePictureInPicture:"",className:"video"},/*#__PURE__*/index_js_default().createElement("source",{src:beats_ad,type:"video/mp4"})),/*#__PURE__*/index_js_default().createElement("div",{className:"text-wrapper"},/*#__PURE__*/index_js_default().createElement("p",null,/*#__PURE__*/index_js_default().createElement("span",null,/*#__PURE__*/index_js_default().createElement("strong",null,"Coming Soon")),/*#__PURE__*/index_js_default().createElement("span",null,"eCommerce store"))))));}
;// CONCATENATED MODULE: ./src/vids/footer-3.mp4
/* harmony default export */ const footer_3 = ("/static/footer-3-305ae5286ff8c013ca9848279d5ff2c3.mp4");
;// CONCATENATED MODULE: ./src/Components/Home/Footer/Footer.jsx
gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);function Footer(){// Personal Links
const footerContainer=(0,index_js_.useRef)(null);const heading0=(0,index_js_.useRef)(null);const heading1=(0,index_js_.useRef)(null);(0,index_js_.useEffect)(()=>{//container parallax
gsapWithCSS.fromTo(footerContainer.current,{y:()=>-window.innerHeight},{y:0,scrollTrigger:{trigger:footerContainer.current,scrub:true,start:"center bottom",end:"bottom top"}});//heading scroll trigger opening
gsapWithCSS.fromTo(heading0.current,{rotation:6,opacity:0,y:()=>heading0.current.clientHeight*.5},{rotation:0,y:0,opacity:1,duration:.7,ease:'power4.easeOut',scrollTrigger:{trigger:footerContainer.current,start:'center center'}});gsapWithCSS.fromTo(heading1.current,{rotation:6,opacity:0,y:()=>heading1.current.clientHeight*.5},{rotation:0,y:0,opacity:1,duration:.7,ease:'power4.easeOut',scrollTrigger:{trigger:footerContainer.current,start:'center center'}});},[]);return/*#__PURE__*/index_js_default().createElement("footer",{className:"center",ref:footerContainer},/*#__PURE__*/index_js_default().createElement("div",{id:"footer-content",className:"content-width column"},/*#__PURE__*/index_js_default().createElement("h2",null,/*#__PURE__*/index_js_default().createElement("div",{className:"anim"},/*#__PURE__*/index_js_default().createElement("div",{ref:heading0},"Jake")),/*#__PURE__*/index_js_default().createElement("div",{className:"anim"},/*#__PURE__*/index_js_default().createElement("div",{ref:heading1},"Pearson"))),/*#__PURE__*/index_js_default().createElement("p",null,"creativity driven with a",/*#__PURE__*/index_js_default().createElement("br",null),"passionate focus on innovation."),/*#__PURE__*/index_js_default().createElement("hr",null),/*#__PURE__*/index_js_default().createElement("div",{id:"footer-final-p",className:"block"},/*#__PURE__*/index_js_default().createElement("div",{className:"footer-list"},/*#__PURE__*/index_js_default().createElement("ul",{className:"link-list"},/*#__PURE__*/index_js_default().createElement("li",null,/*#__PURE__*/index_js_default().createElement("a",{href:"/#"},"jpearsonbusiness@gmail.com")),/*#__PURE__*/index_js_default().createElement("li",null,/*#__PURE__*/index_js_default().createElement("a",{href:"https://www.linkedin.com/in/jakepearson123/",target:"_blank",rel:"noopener noreferrer"},"LinkedIn")),/*#__PURE__*/index_js_default().createElement("li",null,/*#__PURE__*/index_js_default().createElement("a",{href:"https://www.dribbble.com/jopearson",target:"_blank",rel:"noopener noreferrer"},"Dribbble")),/*#__PURE__*/index_js_default().createElement("li",null,/*#__PURE__*/index_js_default().createElement("a",{href:"https://www.behance.net/jakepearson5",target:"_blank",rel:"noopener noreferrer"},"Behance")),/*#__PURE__*/index_js_default().createElement("li",null,/*#__PURE__*/index_js_default().createElement("a",{href:"https://github.com/DaCodeWiz",target:"_blank",rel:"noopener noreferrer"},"GitHub")))))),/*#__PURE__*/index_js_default().createElement("div",{className:"background"},/*#__PURE__*/index_js_default().createElement("video",{playsInline:"",loop:"loop",muted:"muted",disablePictureInPicture:"",className:"video",autoPlay:"autoplay"},/*#__PURE__*/index_js_default().createElement("source",{src:footer_3,type:"video/mp4"}))));}
;// CONCATENATED MODULE: ./src/Components/Home/Home.js
function Home(){return/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null,/*#__PURE__*/index_js_default().createElement(Hero,null),/*#__PURE__*/index_js_default().createElement(Work,null),/*#__PURE__*/index_js_default().createElement(Reel,null),/*#__PURE__*/index_js_default().createElement(News,null),/*#__PURE__*/index_js_default().createElement(Footer,null));}/* harmony default export */ const Home_Home = (Home);
;// CONCATENATED MODULE: ./src/Components/App.js
// import LoadingScreen from "./Components/LoadingScreen/LoadingScreen"
// import CursorIcon from './Components/CursorIcon/CursorIcon'
function App(){// const [loadingVisible, setLoadingVisible] = useState(true)
//Create cursor icon
// useEffect(() => { new CursorIcon() }, [])
/**
   * Smooth scroll
   * and unlock scrolling after loading is complete
   */(0,index_js_.useEffect)(()=>{setTimeout(()=>{const lenis=new e({lerp:.1,smooth:true});const scrollFn=()=>{lenis.raf();requestAnimationFrame(scrollFn);};requestAnimationFrame(scrollFn);},3800);},[]);return/*#__PURE__*/index_js_default().createElement("div",{className:"center column"},/*#__PURE__*/index_js_default().createElement(Home_Home,null));}
;// CONCATENATED MODULE: ./src/pages/index.js
const IndexPage=()=>{return/*#__PURE__*/index_js_.createElement(App,null);};/* harmony default export */ const pages = (IndexPage);const Head=()=>/*#__PURE__*/index_js_.createElement("title",null,"Jake Portfolio");
